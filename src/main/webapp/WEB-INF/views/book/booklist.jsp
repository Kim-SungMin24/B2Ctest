	...
	<h2>대여 가능 도서</h2><br/>
 	<div class="row">
	  ...
	  <c:if test="${empty item.rentalid }">
		  <div class="card col-4" style= "width:400px; height: 400px; border: ; text-align: center;" > <!-- col-4 4개의 칼럼이 나타남 -->
			  <a href = "/book/bookdetail/${item.bookid }">
			    <img class="card-img-top" src="/resource/img/${item.img }" alt="Card image" style="width:250px;height:280px">
			      </a>
